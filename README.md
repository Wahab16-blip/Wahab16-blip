# Wahab Olanipekun — AI Engineer

> CS Student at the University of Sunderland (Year 3) · Building production AI tools from scratch · Every line of code, written myself.
...
> AI-powered tactical analysis tool for football coaches

A multi-tool AI agent that takes squad data, fetches live weather, searches a tactical knowledge base using RAG, and generates detailed match reports with formation visualisation.

**Key features:**
- Squad manager with position-specific ability ratings (Positioning, Defending, Passing, Aerial, Speed, Dribbling, Shooting)
- AI generates 3 formation recommendations based on real player data
- Multi-tool agent loop — weather API + RAG pipeline + Claude
...
- Variable income tracking (shifts, allowances, freelance, salary)
...
Self-directed AI engineering curriculum completed alongside university coursework:
...
![Wahab's GitHub Stats](https://github-readme-stats.vercel.app/api?username=Wahab16-blip&show_icons=true&theme=github_dark&hide_border=true&bg_color=0D1117&title_color=6366F1&icon_color=6366F1&text_color=E6EDF3)
